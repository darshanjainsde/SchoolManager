 ...
 *
 * Ported verbatim from apps/web/lib/teacher-day.ts so the phone and the
 * browser never disagree about what "now" means — see that file for the
 * canonical edge-case writeup. Summary of the pinned semantics:
 *
