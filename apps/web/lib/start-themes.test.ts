...
const ALLOWED = {
  ...
  sectionShape: ['SOFT', 'EDITORIAL', 'CRISP', 'PANELS', 'SLANT', 'NOTCH', 'WAVE'],
  motionGesture: ['RISE', 'FADE', 'DRAW', 'SLIDE', 'ZOOM', 'CURTAIN', 'FLIP'],
  backgroundTexture: ['NONE', 'GRID', 'DOTS', 'PAPER'],
  scrollFeel: ['CLASSIC', 'GLIDE', 'SNAP', 'DECK', 'HORIZONTAL', 'ZOOM', 'REVEAL', 'TILT'],
