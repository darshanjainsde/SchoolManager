...
export default async function NavGroupOverviewPage({
  ...
  const nodes = navModel({
    flags: {
      ...
      hasEvents: data.school.features.includes('EVENTS'), hasAlumni: data.school.features.includes('ALUMNI'), hasBirthdays: !!data.celebrations?.enabled, hasRecords: !!data.records?.enabled,
