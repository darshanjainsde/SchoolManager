...
export default function LibraryHallPage() {
  const host = useHost();
  ...
  if (hall.isLoading || !hall.data) {
    return <p className="py-10 text-center text-sm text-[var(--sk-ink-3)]">Checking the hall…</p>;
  }
  const d = hall.data;
          ...
          {!d.section ? (
            ...
            <>
              <div className="flex flex-wrap items-center gap-2 border-b border-[var(--sk-line)] bg-[var(--sk-brand-tint)] px-3 py-2 text-xs text-[var(--sk-brand-2)]">
                {retaking ? (
                  <>
                    ✏️ <b>Retaking for the library.</b> Tap a student to flip Present → Absent → Late.
                    <span className="ml-auto flex gap-1.5">
                      <button
                        className="rounded-lg bg-[var(--sk-brand)] px-3 py-1 font-bold text-white"
                      ...
                      <button
                        className="rounded-lg border border-[var(--sk-line)] bg-[var(--sk-card)] px-3 py-1 font-bold text-[var(--sk-ink-2)]"
                  ...
                  <>
                    ✏️ <b>No register yet today.</b> Take the library&rsquo;s own.
