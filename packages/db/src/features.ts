...
export type FeatureKey =
  ...
  | 'ABOUT_CONTACT' | 'EVENTS' | 'MANAGEMENT' | 'BLOG' | 'HIRING' | 'LIBRARY' | 'ALUMNI' | 'FEES' | 'PRESS' | 'SPORTS' | 'SALARY';

const ALL_KEYS: FeatureKey[] = ['PUBLIC_SITE','GALLERY','ENQUIRY','SOCIAL','ABOUT_CONTACT','EVENTS','MANAGEMENT','BLOG','HIRING','LIBRARY','ALUMNI','FEES','PRESS','SPORTS','SALARY'];
...
// ALUMNI, PRESS, SPORTS and SALARY are in NO tier, deliberately and for the same reason LIBRARY is not:
